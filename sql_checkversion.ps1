...
$Output = ForEach ($servers in Get-Content "C:\scripts\scriptsforadmin\instances.txt")
{
...
$list | where { $_.DisplayName -match 'SQL'} | select ComputerName, DisplayName, DisplayVersion | FT
...
$Output | Out-File -FilePath C:\scripts\scriptsforadmin\txt\SQL_SERVERS_VERSION.txt